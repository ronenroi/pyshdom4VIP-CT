...
def main(cloud_indices):
    ...
    run_params = load_run_params(params_path="configs/params_varying_imagers.yaml")
    ...
    for cloud_index in cloud_indices:
        ...
        if run_params['DOFORWARD']:
            ...
            vis_CloudCT_VIEWS, _ = CloudCT_setup.CreateVaryingImagers(SATS_NUMBER=SATS_NUMBER_SETUP,
